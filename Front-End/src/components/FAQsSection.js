      ...
      <ul>
        <li>
          <div className="faq-question" onClick={() => toggleAnswer(0)}>
            ...
            <span className="toggle-icon">{openIndex === 0 ? "-" : "+"}</span>
          </div>
          {openIndex === 0 && (
            <p>
        ...
        <li>
          <div className="faq-question" onClick={() => toggleAnswer(1)}>
            ...
            <span className="toggle-icon">{openIndex === 1 ? "-" : "+"}</span>
          </div>
        ...
        <li>
          <div className="faq-question" onClick={() => toggleAnswer(2)}>
            ...
            <span className="toggle-icon">{openIndex === 2 ? "-" : "+"}</span>
          </div>
          {openIndex === 2 && (
        ...
        <li>
          <div className="faq-question" onClick={() => toggleAnswer(3)}>
            ...
            <span className="toggle-icon">{openIndex === 3 ? "-" : "+"}</span>
          </div>
          {openIndex === 3 && (
            <p>
